...
export default function CaseStudyHeader({
  ...
  return (
    <div
      className={`w-full relative bg-[#111] overflow-hidden ${className ? className : "h-[80vh] min-h-[600px] mb-16"}`}
    >
      <RevealOnScroll className="w-full h-full">
        {/* Background visual — full viewport width */}
        ...
        {/* Copy + metadata — same max width as case study body (max-w-case) */}
        <div className="absolute bottom-0 left-0 right-0 z-10 pb-8 pt-8 md:pb-12 md:pt-12">
          <div className="max-w-case mx-auto w-full px-4 md:px-6">
            {label && (
              <div className="mb-4">
